...
use mdao_runtime::{self, opaque::Block, GenesisConfig, RuntimeApi};
...
native_executor_instance!(
	pub Executor,
	mdao_runtime::api::dispatch,
	mdao_runtime::native_version,
);
...
macro_rules! new_full_start {
	($config:expr) => {{
		...
		let builder = sc_service::ServiceBuilder::new_full::<
			mdao_runtime::opaque::Block,
			mdao_runtime::RuntimeApi,
		...
		.with_import_queue(|_config, client, mut select_chain, transaction_pool| {
			...
			let (grandpa_block_import, grandpa_link) =
				grandpa::block_import::<_, _, _, mdao_runtime::RuntimeApi, _>(client.clone(), &*client, select_chain)?;
