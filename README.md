...
```bash
./target/release/mdao purge-chain --dev
```

Start a development chain with:

```bash
./target/release/mdao --dev
```
...
You can generate your own Substrate mdao based on a particular Substrate
...
# Switch to a particular branch or commit of the Substrate repo your mdao based on
...
.maintain/mdao-release.sh ../mdao.tar.gz
```
